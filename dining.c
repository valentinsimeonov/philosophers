...
/*   Updated: 2022/05/25 15:16:11 by vsimeono         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*dinner(void *philo)
{
	...
	at_the_table(game, philosopher, right, left);
	return (NULL);
}

void	at_the_table(t_game *game, \
t_philosopher *philosopher, int right, int left)
{
