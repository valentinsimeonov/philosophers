...
/*   Updated: 2022/05/24 14:45:56 by vsimeono         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	initialize_table(t_game *game, int argc, char **argv)
{
	...
	game->to_philosopher = (t_philosopher **) \
	malloc(sizeof(t_philosopher *) * game->number_of_philos);
...
void	initialize_forks(t_game *game)
{
	...
	i = 0;
	game->m_forks = (pthread_mutex_t *) \
	malloc(sizeof(pthread_mutex_t) * game->number_of_philos);
